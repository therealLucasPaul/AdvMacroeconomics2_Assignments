...
options_ = [];
M_.fname = 'NKmodel_nonlin_Abgabe';
...
M_.exo_names(3) = {'epe'};
M_.exo_names_tex(3) = {'epe'};
M_.exo_names_long(3) = {'epe'};
...
M_.endo_names(12) = {'PE'};
M_.endo_names_tex(12) = {'PE'};
M_.endo_names_long(12) = {'PE'};
...
M_.param_names(15) = {'rho_pe'};
M_.param_names_tex(15) = {'rho\_pe'};
M_.param_names_long(15) = {'rho_pe'};
...
M_.param_names(18) = {'Ass'};
M_.param_names_tex(18) = {'Ass'};
M_.param_names_long(18) = {'Ass'};
M_.param_names(19) = {'PIss'};
M_.param_names_tex(19) = {'PIss'};
M_.param_names_long(19) = {'PIss'};
M_.param_names(20) = {'Yss'};
M_.param_names_tex(20) = {'Yss'};
M_.param_names_long(20) = {'Yss'};
M_.param_names(21) = {'Css'};
M_.param_names_tex(21) = {'Css'};
M_.param_names_long(21) = {'Css'};
M_.param_names(22) = {'Nss'};
M_.param_names_tex(22) = {'Nss'};
M_.param_names_long(22) = {'Nss'};
M_.param_names(23) = {'Wss'};
M_.param_names_tex(23) = {'Wss'};
M_.param_names_long(23) = {'Wss'};
M_.param_names(24) = {'MCss'};
M_.param_names_tex(24) = {'MCss'};
M_.param_names_long(24) = {'MCss'};
M_.param_names(25) = {'Rss'};
M_.param_names_tex(25) = {'Rss'};
M_.param_names_long(25) = {'Rss'};
M_.param_names(26) = {'Yflexss'};
M_.param_names_tex(26) = {'Yflexss'};
M_.param_names_long(26) = {'Yflexss'};
M_.param_names(27) = {'Rrealss'};
M_.param_names_tex(27) = {'Rrealss'};
M_.param_names_long(27) = {'Rrealss'};
M_.param_names(28) = {'GAPss'};
M_.param_names_tex(28) = {'GAPss'};
M_.param_names_long(28) = {'GAPss'};
...
M_.params(19) = 1;
PIss = M_.params(19);
M_.params(20) = ((M_.params(7)-1)/M_.params(7)*M_.params(18)^(1+M_.params(4)))^(1/(M_.params(3)+M_.params(4)));
Yss = M_.params(20);
M_.params(21) = M_.params(20);
Css = M_.params(21);
M_.params(22) = M_.params(20);
Nss = M_.params(22);
M_.params(23) = (M_.params(7)-1)/M_.params(7);
Wss = M_.params(23);
M_.params(24) = M_.params(23)/M_.params(18);
MCss = M_.params(24);
M_.params(25) = M_.params(19)/M_.params(2);
Rss = M_.params(25);
M_.params(26) = M_.params(20);
Yflexss = M_.params(26);
M_.params(27) = M_.params(25)/M_.params(19);
Rrealss = M_.params(27);
M_.params(28) = M_.params(20)/M_.params(26);
GAPss = M_.params(28);
%
...
options_.irf = 20;
options_.order = 1;
var_list_ = {'PI';'R';'V';'A';'Y';'C';'N';'MC';'W';'EN';'PE'};
...
save([M_.dname filesep 'Output' filesep 'NKmodel_nonlin_Abgabe_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKmodel_nonlin_Abgabe_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKmodel_nonlin_Abgabe_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKmodel_nonlin_Abgabe_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKmodel_nonlin_Abgabe_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKmodel_nonlin_Abgabe_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKmodel_nonlin_Abgabe_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
