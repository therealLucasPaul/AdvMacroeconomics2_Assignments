...
//
// Solving the baseline NK model under FLEXIBLE prices, model variables specified in log-linear terms
//
...
stoch_simul(irf=20, order=1) gap pi_ann i_ann r_ann y n w v a;      
